...
BEGIN = """
    <button type='button' id='%(divid)s_show' class='btn btn-default btn-small' onclick="$(this).hide();$('#%(divid)s').show();$('#%(divid)s_hide').show();$('#%(divid)s').find('.CodeMirror').each(function(i, el){el.CodeMirror.refresh();});">%(showtitle)s</button>
