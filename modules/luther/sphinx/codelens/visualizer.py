...
<div id="%(divid)s_modal" class="basic-modal-content">
    ...
    <button id="%(divid)s_tracecheck" class='btn btn-default btn-small tracecheck' onclick="traceQCheckMe('%(divid)s_textbox','%(divid)s','%(correct)s')">Check
    Me</button>
    <button class='btn btn-default btn-small close-modal' onclick="closeModal('%(divid)s')">Continue...</button>
