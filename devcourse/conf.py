...
extensions = ['sphinx.ext.mathjax','luther.sphinx.video','luther.sphinx.reveal','luther.sphinx.poll','luther.sphinx.disqus','luther.sphinx.tabbedStuff','luther.sphinx.codelens','luther.sphinx.activecode', 'luther.sphinx.assess', 'luther.sphinx.animation','luther.sphinx.meta','gatech.parsons']
...
html_theme_options = {
    ...
    'navbar_title': "Python Courseware",
...
html_theme_path = ["../static/plugin_layouts"]
