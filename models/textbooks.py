...
db.define_table(
    ...
    Field("base_book", type="string", notnull=True), #regname of the original book that this copy was created from
    Field("webhook_code", type="string", notnull=True), #randomly generated on book creation, used for verifying authenticity of recieved webhook data
    ...
    Field("drafts_directory",type="string"), #directory created by runestone build + runestone deploy (for the draft book)
    Field("published_directory",type="string"), #directory created by runestone build + runestone deploy (for the published book)
