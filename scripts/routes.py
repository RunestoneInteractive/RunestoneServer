...
routes_in = (
    (r".*:/favicon.ico", r"/runestone/static/favicon.ico"),
    (r".*:/robots.txt", r"/examples/static/robots.txt"),
    (
        r".*/courselib/static/thinkcspy/(?P<any>.*)",
        r"/runestone/static/thinkcspy/\g<any>",
    ),
    (
        r".*/courselib/static/pythonds/(?P<any>.*)",
        r"/runestone/static/pythonds/\g<any>",
    ),
    (
        r".*/courselib/static/everyday/(?P<any>.*)",
        r"/runestone/static/everyday/\g<any>",
    ),
...
#
routes_onerror = [("runestone/static/404", "/runestone/static/fail.html")]
