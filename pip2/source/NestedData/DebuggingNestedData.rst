...
To illustrate this, we will walk through extracting information from the data returned from the flickr API. This nested dictionary results from querying Twitter, asking for three tweets matching "tour de France". As you'll see, it's quite a daunting data structure, even when printed with nice indentation as it's shown below. 
